    ...
    C: Send + Sync + 'static,
{
    ...
    Router::new()
        ...
        .route(
            ...
            get(sandbox_allocation_owner_get::<I, A, E, C>),
        )
        .route(
            "/sandbox-allocations/{allocation_id}",
            delete(sandbox_allocations_allocation_id_delete::<I, A, E, C>)
                .get(sandbox_allocations_allocation_id_get::<I, A, E, C>)
                .post(sandbox_allocations_allocation_id_post::<I, A, E, C>),
        )
        .route(
            "/sandboxes",
...
#[tracing::instrument(skip_all)]
fn sandbox_allocation_owner_get_validation() -> std::result::Result<(), ValidationErrors> {
    Ok(())
}
/// SandboxAllocationOwnerGet - GET /sandbox-allocation-owner
#[tracing::instrument(skip_all)]
async fn sandbox_allocation_owner_get<I, A, E, C>(
    method: Method,
    TypedHeader(host): TypedHeader<Host>,
    cookies: CookieJar,
    headers: HeaderMap,
    ...
    E: std::fmt::Debug + Send + Sync + 'static,
{
    ...
    #[allow(clippy::redundant_closure)]
    let validation = tokio::task::spawn_blocking(move || sandbox_allocation_owner_get_validation())
        .await
        .unwrap();
    ...
    let result = api_impl
        .as_ref()
        .sandbox_allocation_owner_get(&method, &host, &cookies, &claims)
        .await;
    ...
    let resp = match result {
        Ok(rsp) => match rsp {
            apis::sandboxes::SandboxAllocationOwnerGetResponse::Status200_AllocationOwner(body) => {
                let mut response = response.status(200);
                {
                    let mut response_headers = response.headers_mut().unwrap();
                    response_headers
            ...
            apis::sandboxes::SandboxAllocationOwnerGetResponse::Status401_AuthenticationError(
                body,
            ) => {
                let mut response = response.status(401);
                {
            ...
            apis::sandboxes::SandboxAllocationOwnerGetResponse::Status500_ServerError(body) => {
                let mut response = response.status(500);
                {
                    let mut response_headers = response.headers_mut().unwrap();
                    response_headers
...
#[tracing::instrument(skip_all)]
fn sandbox_allocations_allocation_id_delete_validation(
    ...
    (
        models::SandboxAllocationsAllocationIdDeleteHeaderParams,
        models::SandboxAllocationsAllocationIdDeletePathParams,
    ),
    ValidationErrors,
> {
...
#[tracing::instrument(skip_all)]
async fn sandbox_allocations_allocation_id_delete<I, A, E, C>(
    method: Method,
    TypedHeader(host): TypedHeader<Host>,
    cookies: CookieJar,
    headers: HeaderMap,
    Path(path_params): Path<models::SandboxAllocationsAllocationIdDeletePathParams>,
    State(api_impl): State<I>,
) -> Result<Response, StatusCode>
where
    I: AsRef<A> + Send + Sync,
    ...
    E: std::fmt::Debug + Send + Sync + 'static,
{
    ...
    // Header parameters
    let header_params = {
        let header_x_agentenv_allocation_owner =
            headers.get(HeaderName::from_static("x-agentenv-allocation-owner"));

        let header_x_agentenv_allocation_owner = match header_x_agentenv_allocation_owner {
                ...
                Err(err) => {
                    return Response::builder()
                        ...
                        .body(Body::from(format!(
                            "Invalid header X-Agentenv-Allocation-Owner - {err}"
                        )))
                        .map_err(|e| {
                            error!(error = ?e);
                            StatusCode::INTERNAL_SERVER_ERROR
            ...
            None => {
                return Response::builder()
                    .status(StatusCode::BAD_REQUEST)
                    .body(Body::from(
                        "Missing required header X-Agentenv-Allocation-Owner",
                    ))
                    .map_err(|e| {
                        error!(error = ?e);
                        StatusCode::INTERNAL_SERVER_ERROR
        ...
        models::SandboxAllocationsAllocationIdDeleteHeaderParams {
            x_agentenv_allocation_owner: header_x_agentenv_allocation_owner,
        }
    };

    #[allow(clippy::redundant_closure)]
    let validation = tokio::task::spawn_blocking(move || {
        sandbox_allocations_allocation_id_delete_validation(header_params, path_params)
    })
    .await
    .unwrap();
    ...
    let result = api_impl
        .as_ref()
        .sandbox_allocations_allocation_id_delete(
            &method,
            &host,
            &cookies,
            &claims,
    ...
    let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::sandboxes::SandboxAllocationsAllocationIdDeleteResponse::Status200_AllocationReceipt
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
                                                ...
                                                apis::sandboxes::SandboxAllocationsAllocationIdDeleteResponse::Status400_BadRequest
                                                    (body)
                                                => {
                                                ...
                                                apis::sandboxes::SandboxAllocationsAllocationIdDeleteResponse::Status401_AuthenticationError
                                                    (body)
                                                => {
                                                  let mut response = response.status(401);
                                                  {
                                                ...
                                                apis::sandboxes::SandboxAllocationsAllocationIdDeleteResponse::Status409_Conflict
                                                    (body)
                                                => {
                                                ...
                                                apis::sandboxes::SandboxAllocationsAllocationIdDeleteResponse::Status500_ServerError
                                                    (body)
                                                => {
                                                  let mut response = response.status(500);
                                                  {
...
#[tracing::instrument(skip_all)]
fn sandbox_allocations_allocation_id_get_validation(
    ...
    (
        models::SandboxAllocationsAllocationIdGetHeaderParams,
        models::SandboxAllocationsAllocationIdGetPathParams,
    ),
    ValidationErrors,
> {
    header_params.validate()?;
...
#[tracing::instrument(skip_all)]
async fn sandbox_allocations_allocation_id_get<I, A, E, C>(
    method: Method,
    TypedHeader(host): TypedHeader<Host>,
    cookies: CookieJar,
    headers: HeaderMap,
    Path(path_params): Path<models::SandboxAllocationsAllocationIdGetPathParams>,
    State(api_impl): State<I>,
) -> Result<Response, StatusCode>
where
    I: AsRef<A> + Send + Sync,
    ...
    E: std::fmt::Debug + Send + Sync + 'static,
{
    ...
    #[allow(clippy::redundant_closure)]
    let validation = tokio::task::spawn_blocking(move || {
        sandbox_allocations_allocation_id_get_validation(header_params, path_params)
    })
    .await
    .unwrap();
    ...
    let result = api_impl
        .as_ref()
        .sandbox_allocations_allocation_id_get(
            &method,
            &host,
            &cookies,
            &claims,
    ...
    let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::sandboxes::SandboxAllocationsAllocationIdGetResponse::Status200_AllocationReceipt
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
                                                ...
                                                apis::sandboxes::SandboxAllocationsAllocationIdGetResponse::Status400_BadRequest
                                                    (body)
                                                => {
                                                  let mut response = response.status(400);
                                                  {
                                                ...
                                                apis::sandboxes::SandboxAllocationsAllocationIdGetResponse::Status401_AuthenticationError
                                                    (body)
                                                => {
                                                  let mut response = response.status(401);
                                                  {
                                                ...
                                                apis::sandboxes::SandboxAllocationsAllocationIdGetResponse::Status404_NotFound
                                                    (body)
                                                => {
                                                  let mut response = response.status(404);
                                                  {
                                                ...
                                                apis::sandboxes::SandboxAllocationsAllocationIdGetResponse::Status409_Conflict
                                                    (body)
                                                => {
                                                  let mut response = response.status(409);
                                                  {
                                                ...
                                                apis::sandboxes::SandboxAllocationsAllocationIdGetResponse::Status500_ServerError
                                                    (body)
                                                => {
                                                  let mut response = response.status(500);
                                                  {
...
#[allow(dead_code)]
struct SandboxAllocationsAllocationIdPostBodyValidator<'a> {
    #[validate(nested)]
    body: &'a models::NewSandbox,
}

#[tracing::instrument(skip_all)]
fn sandbox_allocations_allocation_id_post_validation(
    ...
    (
        models::SandboxAllocationsAllocationIdPostHeaderParams,
        models::SandboxAllocationsAllocationIdPostPathParams,
        models::NewSandbox,
    ),
    ValidationErrors,
> {
    header_params.validate()?;
    path_params.validate()?;
    let b = SandboxAllocationsAllocationIdPostBodyValidator { body: &body };
    b.validate()?;
...
#[tracing::instrument(skip_all)]
async fn sandbox_allocations_allocation_id_post<I, A, E, C>(
    method: Method,
    TypedHeader(host): TypedHeader<Host>,
    cookies: CookieJar,
    headers: HeaderMap,
    Path(path_params): Path<models::SandboxAllocationsAllocationIdPostPathParams>,
    State(api_impl): State<I>,
    ...
    E: std::fmt::Debug + Send + Sync + 'static,
{
    ...
    #[allow(clippy::redundant_closure)]
    let validation = tokio::task::spawn_blocking(move || {
        sandbox_allocations_allocation_id_post_validation(header_params, path_params, body)
    })
    .await
    .unwrap();
    ...
    let result = api_impl
        .as_ref()
        .sandbox_allocations_allocation_id_post(
            &method,
            &host,
            &cookies,
            &claims,
    ...
    let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::sandboxes::SandboxAllocationsAllocationIdPostResponse::Status201_TheSandboxWasCreatedSuccessfully
                                                    {
                                                        body,
                                                ...
                                                apis::sandboxes::SandboxAllocationsAllocationIdPostResponse::Status401_AuthenticationError
                                                    (body)
                                                => {
                                                  let mut response = response.status(401);
                                                  {
                                                ...
                                                apis::sandboxes::SandboxAllocationsAllocationIdPostResponse::Status400_BadRequest
                                                    (body)
                                                => {
                                                  let mut response = response.status(400);
                                                  {
                                                ...
                                                apis::sandboxes::SandboxAllocationsAllocationIdPostResponse::Status409_Conflict
                                                    (body)
                                                => {
                                                  let mut response = response.status(409);
                                                  {
                                                ...
                                                apis::sandboxes::SandboxAllocationsAllocationIdPostResponse::Status500_ServerError
                                                    (body)
                                                => {
                                                  let mut response = response.status(500);
                                                  {
